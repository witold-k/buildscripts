...
set(CMAKE_TARGET_SYSTEM_IS_NATIVE 1 CACHE BOOL "is defined and true only when build is executable on build machine")
...
#message("#### TOOLCHAIN linux_gcc")

# -----------------------------------------------------------------------------

set(TOOLCHAIN_PREFIX  "x86_64-unknown-linux-gnu-")
set(TOOLCHAIN_POSTFIX "")
set(TOOLCHAIN_BASE    "/opt/compiler/${TOOLCHAIN_VERSION}/${TOOLCHAIN_VERSION}/x-tools/x86_64-unknown-linux-gnu")
set(TOOLCHAIN_SYSROOT "${TOOLCHAIN_BASE}/x86_64-unknown-linux-gnu/sysroot" CACHE STRING "toolchain sysroot")
set(TOOLCHAIN_DIR     "${TOOLCHAIN_BASE}/bin")
set(TOOLCHAIN_SHAREDLIB_SUFFIX ".so")

set(LIBRARAY_SYSTEMDIR "x86_64-linux-gnu")
set(UNIX "true" CACHE BOOL "os name")
...
set(GCC_COMMON_FLAGS "${GCC_COMMON_FLAGS} ${SIZEOF_FLAGS} ${HAVE_H_FLAGS} ${HAVE_T_FLAGS} ${HAVE_FLAGS} -fPIC -ggdb -fstack-protector-strong -O2 ${GCC_COVERAGE_COMPILE_FLAGS} -D_VARIANT_LINUX_ -D_VARIANT_POSIX_ -D_OS_LINUX_ -D_COMP_GCC_ -D_ARCH_X86_64_")
...
if (CMAKE_MODULE_PATH)
    ...
    set(CMAKE_MODULE_PATH "${CMAKE_MODULE_PATH}" CACHE STRING "fix module path" FORCE)
endif()
