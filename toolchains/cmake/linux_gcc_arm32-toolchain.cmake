...
#message("#### TOOLCHAIN linux_gcc_arm32")

# -----------------------------------------------------------------------------

set(TOOLCHAIN_PREFIX  "arm-unknown-linux-gnueabihf-")
set(TOOLCHAIN_POSTFIX "")
set(TOOLCHAIN_BASE    "/opt/compiler/${TOOLCHAIN_VERSION}/${TOOLCHAIN_VERSION}/x-tools/arm-unknown-linux-gnueabihf")
set(TOOLCHAIN_SYSROOT "${TOOLCHAIN_BASE}/arm-unknown-linux-gnueabihf/sysroot" CACHE STRING "toolchain sysroot")
...
set(GCC_COMMON_FLAGS "${SIZEOF_FLAGS} ${HAVE_H_FLAGS} ${HAVE_T_FLAGS} ${HAVE_FLAGS} ${GCC_COMMON_FLAGS} -fPIC -fstack-protector-strong -O2 -D_VARIANT_LINUX_ -D_VARIANT_POSIX_ -D_OS_LINUX_ -D_COMP_GCC_")
